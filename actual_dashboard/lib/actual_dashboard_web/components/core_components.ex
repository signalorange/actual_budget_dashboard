defmodule ActualDashboardWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ActualDashboardWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ActualDashboardWeb.Gettext, "errors", msg, opts)
    end
  end
